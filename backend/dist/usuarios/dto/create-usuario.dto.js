...
__decorate([
    (0, class_validator_1.IsEnum)(['ADMIN', 'RRHH', 'FUNCIONARIO'], { message: 'Rol inválido. Debe ser: ADMIN, RRHH o FUNCIONARIO' }),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'La dependencia es requerida' }),
    __metadata("design:type", String)
], CreateUsuarioDto.prototype, "dependencia", void 0);
