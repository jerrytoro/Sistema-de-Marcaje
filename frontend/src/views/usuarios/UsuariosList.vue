            ...
            <div class="card-body">
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" placeholder="Usuario, nombre o apellido..."
                ...
                <div class="col-md-2 d-flex align-items-end">
                  <button class="btn btn-outline-secondary w-100" @click="usuariosStore.clearFilters()">
                  ...
                  <tbody>
                    ...
                    <tr v-for="usuario in usuariosStore.usuariosFiltrados" :key="usuario.id">
                      ...
                      <td class="text-center">
                        <span v-if="usuario.funcionario?.facialDataRegistered" class="badge bg-success"
                      ...
                      <!-- Telegram -->
                      <td class="text-center">
                        <span v-if="usuario.funcionario?.telegramChatId" class="badge bg-info"
                      ...
                      <td>
                        <div class="btn-group btn-group-sm">
                          <button class="btn btn-outline-primary" @click="selectUsuarioEdit(usuario)" title="Editar">
                            <i class="bi bi-pencil"></i>
                          </button>
                          <button class="btn btn-outline-warning" @click="selectUsuarioPassword(usuario)"
                            title="Cambiar contraseña">
                            <i class="bi bi-key"></i>
                          </button>
                          <button class="btn btn-outline-danger" @click="confirmDelete(usuario)" title="Eliminar">
            ...
            <form @submit.prevent="handleCreate">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" v-model="formCreate.username" required />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Contraseña *</label>
                  <input type="password" class="form-control" v-model="formCreate.password" required />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" v-model="formCreate.nombre" required />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Apellido *</label>
                  <input type="text" class="form-control" v-model="formCreate.apellido" required />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Cargo *</label>
                  <input type="text" class="form-control" v-model="formCreate.cargo" required />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Dependencia *</label>
                  <input type="text" class="form-control" v-model="formCreate.dependencia" required />
                </div>
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="handleUpdate">
              <div class="mb-3">
                <label class="form-label">Usuario</label>
                <input type="text" class="form-control" v-model="formEdit.username" />
              </div>
              <div class="mb-3">
                <label class="form-label">Rol</label>
              ...
              <div class="modal-footer border-0 px-0 pb-0">
                ...
                <button type="submit" class="btn btn-warning" :disabled="usuariosStore.loading">
                  <i class="bi bi-check-circle me-2"></i>
                  Actualizar
                </button>
              </div>
          ...
          <div class="modal-body">
            <form @submit.prevent="handleChangePassword">
              <div class="mb-3">
                ...
                <input type="password" class="form-control" v-model="formPassword.currentPassword" required />
              </div>
              <div class="mb-3">
                <label class="form-label">Nueva Contraseña</label>
                <input type="password" class="form-control" v-model="formPassword.newPassword" required />
              </div>
